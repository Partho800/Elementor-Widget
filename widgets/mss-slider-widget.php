 ...
 */
class MSS_Slider_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Modern Slider', 'mss' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Slide Title' , 'mss' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Slide description goes here.' , 'mss' ),
			]
		);
		...
		$repeater->add_control(
			'button_text',
			[
				'label' => esc_html__( 'Button Text', 'mss' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'Explore' , 'mss' ),
			]
		);
		...
		$repeater->add_control(
			'button_link',
			[
				'label' => esc_html__( 'Button Link', 'mss' ),
		...
		$this->add_control(
			'slides',
			[
				'label' => esc_html__( 'Slides List', 'mss' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'slide_title' => esc_html__( 'Komodo', 'mss' ),
						'slide_description' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus.', 'mss' ),
						'slide_image' => [ 'url' => 'https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?auto=format&fit=crop&q=80&w=1200' ],
					],
					[
						'slide_title' => esc_html__( 'Kerala', 'mss' ),
						'slide_description' => esc_html__( 'Beautiful nature and serene backwaters of India.', 'mss' ),
						'slide_image' => [ 'url' => 'https://images.unsplash.com/photo-1593693397690-362cb9666fc2?auto=format&fit=crop&q=80&w=1200' ],
					],
					[
						'slide_title' => esc_html__( 'Switzerland', 'mss' ),
						'slide_description' => esc_html__( 'The majestic mountains of Matterhorn.', 'mss' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content Style', 'mss' ),
		...
		$this->add_responsive_control(
			'content_width',
			[
				'label' => esc_html__( 'Content Width', 'mss' ),
		...
		$this->start_controls_section(
			'section_title_style',
			[
				'label' => esc_html__( 'Title Style', 'mss' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'title_max_width',
			[
				'label' => esc_html__( 'Max Width', 'mss' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'vw' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			'section_des_style',
			[
				'label' => esc_html__( 'Description Style', 'mss' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Button Style', 'mss' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'card_width',
			[
				'label' => esc_html__( 'Card Width', 'mss' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			'card_height',
			[
				'label' => esc_html__( 'Card Height', 'mss' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'focus_card_height',
			[
				'label' => esc_html__( 'Focus Card Height', 'mss' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			'section_nav_style',
			[
				'label' => esc_html__( 'Navigation Buttons', 'mss' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'nav_btn_size',
			[
				'label' => esc_html__( 'Button Size', 'mss' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [ 'min' => 20, 'max' => 150 ],
		...
		$this->add_control(
			'nav_hover_color',
			[
				'label' => esc_html__( 'Hover Color', 'mss' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#000000',
				'selectors' => [
		...
		$this->add_control(
			'nav_hover_bg',
			[
				'label' => esc_html__( 'Hover Background', 'mss' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#ffffff',
				'selectors' => [
		...
		$this->add_responsive_control(
			'nav_pos_bottom',
			[
				'label' => esc_html__( 'Bottom Offset', 'mss' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'vh' ],
				'range' => [
					'px' => [ 'min' => -100, 'max' => 500 ],
		...
		$this->add_responsive_control(
			'nav_pos_left',
			[
				'label' => esc_html__( 'Left Offset', 'mss' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'vw' ],
				'range' => [
					'px' => [ 'min' => -100, 'max' => 1000 ],
		...
		$this->add_responsive_control(
			'nav_gap',
			[
				'label' => esc_html__( 'Gap Between Buttons', 'mss' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [ 'min' => 0, 'max' => 100 ],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Background Overlay', 'mss' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'overlay_color',
			[
				'label' => esc_html__( 'Overlay Color', 'mss' ),
				'type' => \Elementor\Controls_Manager::COLOR,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Container Style', 'mss' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
