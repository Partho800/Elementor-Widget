...
class PNS_Sticky_Projects_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Sticky Project', 'pns-addons-for-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Stacking Cards (Left Column)', 'pns-addons-for-elementor' ),
		...
		$repeater_cards->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Construction Company', 'pns-addons-for-elementor' ),
				'label_block' => true,
			]
		);
		...
		$repeater_cards->add_control(
			'card_subtitle',
			[
				'label'       => esc_html__( 'Subtitle / Category Tag', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Project 01', 'pns-addons-for-elementor' ),
				'label_block' => true,
			]
		);
		...
		$repeater_cards->add_control(
			'card_desc',
			[
				'label'       => esc_html__( 'Short Description / Text', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXTAREA,
				'default'     => esc_html__( 'Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'pns-addons-for-elementor' ),
				'rows'        => 3,
			]
		);
		...
		$repeater_cards->add_control(
			'card_btn_text',
			[
				'label'       => esc_html__( 'Card Button Text', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'View Project', 'pns-addons-for-elementor' ),
				'label_block' => true,
			]
		);
		...
		$repeater_cards->add_control(
			'card_btn_icon',
			[
				'label'   => esc_html__( 'Card Button Icon', 'pns-addons-for-elementor' ),
		...
		$repeater_cards->add_control(
			'card_image',
			[
				'label'   => esc_html__( 'Card Background Image', 'pns-addons-for-elementor' ),
		...
		$repeater_cards->add_control(
			'card_link',
			[
				'label'       => esc_html__( 'Card Link', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::URL,
				'placeholder' => __( 'https://your-link.com', 'pns-addons-for-elementor' ),
				'default'     => [
					'url' => '#',
				],
			]
		...
		$this->add_control(
			'project_cards',
			[
				'label'       => esc_html__( 'Project Cards List', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater_cards->get_controls(),
				'default'     => [
					[
						'card_title'    => esc_html__( 'Construction Company', 'pns-addons-for-elementor' ),
						'card_subtitle' => esc_html__( 'Project 01', 'pns-addons-for-elementor' ),
						'card_desc'     => esc_html__( 'Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'pns-addons-for-elementor' ),
						'card_btn_text' => esc_html__( 'View Project', 'pns-addons-for-elementor' ),
						'card_image'    => [ 'url' => Utils::get_placeholder_image_src() ],
					],
					[
						'card_title'    => esc_html__( 'Architecture & Design', 'pns-addons-for-elementor' ),
						'card_subtitle' => esc_html__( 'Project 02', 'pns-addons-for-elementor' ),
						'card_desc'     => esc_html__( 'Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'pns-addons-for-elementor' ),
						'card_btn_text' => esc_html__( 'View Project', 'pns-addons-for-elementor' ),
						'card_image'    => [ 'url' => Utils::get_placeholder_image_src() ],
					],
					[
						'card_title'    => esc_html__( 'Warehouse & Logistics', 'pns-addons-for-elementor' ),
						'card_subtitle' => esc_html__( 'Project 03', 'pns-addons-for-elementor' ),
						'card_desc'     => esc_html__( 'Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'pns-addons-for-elementor' ),
						'card_btn_text' => esc_html__( 'View Project', 'pns-addons-for-elementor' ),
						'card_image'    => [ 'url' => Utils::get_placeholder_image_src() ],
					],
		...
		$this->add_control(
			'card_desc_display',
			[
				'label'     => esc_html__( 'Short Text Display Mode', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'hover'  => esc_html__( 'Reveal on Hover', 'pns-addons-for-elementor' ),
					'always' => esc_html__( 'Always Visible', 'pns-addons-for-elementor' ),
					'none'   => esc_html__( 'Hide / Disable', 'pns-addons-for-elementor' ),
				],
				'default'   => 'hover',
				'separator' => 'before',
			]
		...
		$this->add_control(
			'card_btn_display',
			[
				'label'   => esc_html__( 'Card Button Display Mode', 'pns-addons-for-elementor' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'hover'  => esc_html__( 'Reveal on Hover', 'pns-addons-for-elementor' ),
					'always' => esc_html__( 'Always Visible', 'pns-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'base_sticky_top',
			[
				'label'      => esc_html__( 'Sticky Top Base Offset', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [ 'min' => 0, 'max' => 300 ],
		...
		$this->add_responsive_control(
			'stacking_shift',
			[
				'label'      => esc_html__( 'Stacking Top Shift per Card', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [ 'min' => 0, 'max' => 60 ],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Section Header (Right Side)', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'subheading',
			[
				'label'       => esc_html__( 'Subheading / Tag', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'INTRIGUED BY OUR PROJECT?', 'pns-addons-for-elementor' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'heading',
			[
				'label'       => esc_html__( 'Main Heading', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXTAREA,
				'default'     => esc_html__( 'Take a look our best project', 'pns-addons-for-elementor' ),
				'rows'        => 2,
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'heading_tag',
			[
				'label'   => esc_html__( 'Heading HTML Tag', 'pns-addons-for-elementor' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'h1'   => 'H1',
					'h2'   => 'H2',
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::TEXTAREA,
				'default' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo dolor in reprehenderit.', 'pns-addons-for-elementor' ),
				'rows'    => 4,
			]
		);
		...
		$this->add_responsive_control(
			'right_sticky_top',
			[
				'label'      => esc_html__( 'Right Side Sticky Top Offset', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [ 'min' => 0, 'max' => 300 ],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Call to Action Button', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'See All Project', 'pns-addons-for-elementor' ),
				'label_block' => true,
			]
		);
		...
		$this->start_controls_section(
			'section_cards_style',
			[
				'label' => esc_html__( 'Project Cards Container & Overlay', 'pns-addons-for-elementor' ),
		...
		$this->add_control(
			'card_bg_color',
			[
				'label'     => esc_html__( 'Card Fallback Background Color', 'pns-addons-for-elementor' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Bottom Overlay Settings (Text Readability)', 'pns-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'card_overlay_height',
			[
				'label'      => esc_html__( 'Bottom Overlay Height (%)', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range'      => [
					'%' => [ 'min' => 20, 'max' => 100 ],
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Overlay Top Gradient Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Overlay Bottom Tint Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Backdrop Glass Blur', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [ 'min' => 0, 'max' => 20 ],
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Overlay Opacity (Normal)', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Overlay Opacity (Hover)', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [ 'min' => 0, 'max' => 1, 'step' => 0.05 ],
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Card Inner Content Padding', 'pns-addons-for-elementor' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Card Subtitle & Title Style', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Card Subtitle / Tag', 'pns-addons-for-elementor' ),
				'type'  => Controls_Manager::HEADING,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Card Short Text / Description Style', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Card Inner Button Style', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Text & Icon Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#0f172a',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Hover Text & Icon Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#ffffff',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Icon Space / Gap', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Section Header Style (Right)', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Right Button Style', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					'left'   => [ 'title' => esc_html__( 'Left', 'pns-addons-for-elementor' ), 'icon' => 'eicon-text-align-left' ],
					'center' => [ 'title' => esc_html__( 'Center', 'pns-addons-for-elementor' ), 'icon' => 'eicon-text-align-center' ],
					'right'  => [ 'title' => esc_html__( 'Right', 'pns-addons-for-elementor' ), 'icon' => 'eicon-text-align-right' ],
				],
				'default' => 'left',
				'selectors' => [
					...
					<?php if ( ! empty( $settings['project_cards'] ) ) : ?>
						...
						?>
							<div class="ce-project-card-item elementor-repeater-item-<?php echo esc_attr( $card['_id'] ); ?>" style="top: <?php echo esc_attr( $calc_top_px ); ?>px; z-index: <?php echo esc_attr( $index + 1 ); ?>;">
								<a href="<?php echo esc_url( $link_url ); ?>" class="ce-project-card-link"<?php if ( ! empty( $card['card_link']['is_external'] ) ) : ?> target="_blank"<?php endif; ?><?php if ( ! empty( $card['card_link']['nofollow'] ) ) : ?> rel="nofollow"<?php endif; ?>>
									...
									<div class="ce-project-card-content">
										...
										<h3 class="ce-project-card-title" <?php $this->print_render_attribute_string( $repeater_setting_key ); ?>>
				...
				<div class="ce-sticky-right-col">
					<div class="ce-sticky-right-content">
						...
						<?php if ( ! empty( $settings['heading'] ) ) : ?>
							<<?php echo tag_escape( $heading_tag ); ?> class="ce-sticky-heading">
						...
						?>
							<div class="ce-sticky-btn-wrap">
								<a href="<?php echo esc_url( $btn_url ); ?>" class="ce-sticky-btn"<?php if ( ! empty( $settings['button_link']['is_external'] ) ) : ?> target="_blank"<?php endif; ?><?php if ( ! empty( $settings['button_link']['nofollow'] ) ) : ?> rel="nofollow"<?php endif; ?>>
