...
class PNS_Promo_Banner_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Promo Banner Card', 'pns-addons-for-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Banner Settings', 'pns-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			'banner_title_line_1',
			[
				'label'   => esc_html__( 'Title Line 1 (Before button)', 'pns-addons-for-elementor' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Switch', 'pns-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			'banner_title_line_2',
			[
				'label'   => esc_html__( 'Title Line 2', 'pns-addons-for-elementor' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'to Solar, Save', 'pns-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			'banner_title_line_3',
			[
				'label'   => esc_html__( 'Title Line 3', 'pns-addons-for-elementor' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'the Planet Today!', 'pns-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			'show_dashed_pattern',
			[
				'label'        => esc_html__( 'Show Radiating Dashed Accent', 'pns-addons-for-elementor' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Inline Pill Button', 'pns-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Contact Us', 'pns-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			'show_pill_dot',
			[
				'label'        => esc_html__( 'Show White Toggle Dot', 'pns-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'pns-addons-for-elementor' ),
				'label_off'    => esc_html__( 'Hide', 'pns-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Floating Contact Card', 'pns-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			'show_floating_card',
			[
				'label'        => esc_html__( 'Show Floating Card', 'pns-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'pns-addons-for-elementor' ),
				'label_off'    => esc_html__( 'Hide', 'pns-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$repeater->add_control(
			'avatar_image',
			[
				'label'   => esc_html__( 'Avatar Image', 'pns-addons-for-elementor' ),
				'type'    => Controls_Manager::MEDIA,
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
				],
		...
		$this->add_control(
			'avatar_list',
			[
				'label'       => esc_html__( 'Specialist Avatars', 'pns-addons-for-elementor' ),
		...
		$this->add_control(
			'specialist_label',
			[
				'label'     => esc_html__( 'Specialist Title', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => esc_html__( 'Energy', 'pns-addons-for-elementor' ),
				'condition' => [ 'show_floating_card' => 'yes' ],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::TEXT,
				'default'   => esc_html__( '20+', 'pns-addons-for-elementor' ),
				'condition' => [ 'show_floating_card' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'specialist_sublabel',
			[
				'label'     => esc_html__( 'Specialist Subtitle', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => esc_html__( 'Specialist', 'pns-addons-for-elementor' ),
				'condition' => [ 'show_floating_card' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'card_description',
			[
				'label'     => esc_html__( 'Card Subtitle/Text', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::TEXTAREA,
				'default'   => esc_html__( 'Get in touch for sustainable energy today.', 'pns-addons-for-elementor' ),
				'rows'      => 3,
				'condition' => [ 'show_floating_card' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'card_phone_text',
			[
				'label'     => esc_html__( 'Footer Call Link/Phone Text', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => esc_html__( '123 456 7890', 'pns-addons-for-elementor' ),
				'condition' => [ 'show_floating_card' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'card_phone_link',
			[
				'label'       => esc_html__( 'Footer Call Link URL', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::URL,
				'placeholder' => esc_html__( 'tel:1234567890', 'pns-addons-for-elementor' ),
				'default'     => [
					'url'         => 'tel:1234567890',
					'is_external' => false,
					'nofollow'    => false,
		...
		$this->add_control(
			'card_arrow_link',
			[
				'label'       => esc_html__( 'Footer Circle Button Link URL', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::URL,
				'placeholder' => esc_html__( 'https://your-link.com', 'pns-addons-for-elementor' ),
				'default'     => [
					'url'         => '#',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Banner Style', 'pns-addons-for-elementor' ),
		...
		$this->add_control(
			'title_color',
			[
				'label'     => esc_html__( 'Title Text Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#ffffff',
				'selectors' => [
		...
		$this->add_responsive_control(
			'title_max_width',
			[
				'label'      => esc_html__( 'Title Max Width', 'pns-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'banner_padding',
			[
				'label'      => esc_html__( 'Banner Padding', 'pns-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Banner Border Radius', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'default'    => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Dashed Accent Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->start_controls_section(
			'section_pill_style',
			[
				'label' => esc_html__( 'Inline Pill Button Style', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'pill_dot_color',
			[
				'label'     => esc_html__( 'White Dot Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#ffffff',
				'selectors' => [
		...
		$this->add_responsive_control(
			'pill_margin',
			[
				'label'      => esc_html__( 'Margins', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em' ],
				'default'    => [
		...
		$this->start_controls_section(
			'section_card_style',
			[
				'label'     => esc_html__( 'Floating Card Style', 'pns-addons-for-elementor' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [ 'show_floating_card' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'avatar_border_color',
			[
				'label'     => esc_html__( 'Avatar Border Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#ffffff',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Specialist Name', 'pns-addons-for-elementor' ),
		...
		$this->add_control(
			'sublabel_color',
			[
				'label'     => esc_html__( 'Specialist Subtitle Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#64748b',
				'selectors' => [
		...
		$this->add_control(
			'heading_desc_style',
			[
				'label'     => esc_html__( 'Card Subtitle/Description Style', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'heading_phone_style',
			[
				'label'     => esc_html__( 'Call Link Style', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'phone_color',
			[
				'label'     => esc_html__( 'Link Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#0f172a',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Arrow Button Style', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function render() {
		...
		<div class="ce-promo-banner-wrap">
			<div class="ce-promo-banner"<?php if ( ! empty( $settings['banner_image']['url'] ) ) : ?> style="background-image: url('<?php echo esc_url( $settings['banner_image']['url'] ); ?>');"<?php endif; ?>>
						...
						<div class="ce-promo-card">
									...
									<div class="ce-promo-avatars">
										<?php foreach ( $settings['avatar_list'] as $avatar ) : ?>
											<?php if ( ! empty( $avatar['avatar_image']['url'] ) ) : ?>
												<img src="<?php echo esc_url( $avatar['avatar_image']['url'] ); ?>" class="ce-promo-avatar-img" alt="<?php echo esc_attr__( 'Avatar', 'pns-addons-for-elementor' ); ?>">
											<?php endif; ?>
										<?php endforeach; ?>
									</div>
								<?php endif; ?>
							...
							<div class="ce-promo-card-footer">
								<?php if ( ! empty( $settings['card_phone_text'] ) ) : 
									...
									?>
									<a href="<?php echo esc_url( $phone_url ); ?>" class="ce-promo-phone-link"<?php if ( ! empty( $settings['card_phone_link']['is_external'] ) ) : ?> target="_blank"<?php endif; ?><?php if ( ! empty( $settings['card_phone_link']['nofollow'] ) ) : ?> rel="nofollow"<?php endif; ?>>
								...
								?>
								<a href="<?php echo esc_url( $arrow_url ); ?>" class="ce-promo-arrow-btn"<?php if ( ! empty( $settings['card_arrow_link']['is_external'] ) ) : ?> target="_blank"<?php endif; ?><?php if ( ! empty( $settings['card_arrow_link']['nofollow'] ) ) : ?> rel="nofollow"<?php endif; ?>>
									&#x2197;
								</a>
							</div>
