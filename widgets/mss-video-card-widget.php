...
class MSS_Video_Card_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Video Popup Card', 'mss' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'card_bg',
			[
				'label' => esc_html__( 'Background Image', 'mss' ),
		...
		$this->add_control(
			'logo_img',
			[
				'label' => esc_html__( 'Top Logo/Image', 'mss' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
			]
		);
		...
		$this->add_control(
			'video_url',
			[
				'label' => esc_html__( 'YouTube Video URL', 'mss' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'https://www.youtube.com/watch?v=XXXXX', 'mss' ),
		...
		$this->add_control(
			'video_icon',
			[
				'label' => esc_html__( 'Play Icon', 'mss' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'Watch the video', 'mss' ),
			]
		);
		...
		$this->start_controls_tab(
			'overlay_hover',
			[ 'label' => esc_html__( 'Hover', 'mss' ) ]
		);

		$this->add_control(
			'hover_overlay_color',
			[
				'label' => esc_html__( 'Hover Overlay Color', 'mss' ),
				'type' => \Elementor\Controls_Manager::COLOR,
		...
		$this->add_control(
			'overlay_duration',
			[
				'label' => esc_html__( 'Overlay Transition Duration (s)', 'mss' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'zoom_duration',
			[
				'label' => esc_html__( 'Zoom Transition Duration (s)', 'mss' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'logo_width',
			[
				'label' => esc_html__( 'Logo Width', 'mss' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Button & Icon Style', 'mss' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'btn_bg_color',
			[
				'label' => esc_html__( 'Button Background Color', 'mss' ),
				'type' => \Elementor\Controls_Manager::COLOR,
		...
		$this->add_control(
			'btn_hover_bg_color',
			[
				'label' => esc_html__( 'Button Hover BG Color', 'mss' ),
				'type' => \Elementor\Controls_Manager::COLOR,
		...
		$this->add_control(
			'btn_text_color',
			[
				'label' => esc_html__( 'Text & Circle Color', 'mss' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#ffffff',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Icon Color (Inner)', 'mss' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#1a56db',
				'selectors' => [
		...
		$this->add_responsive_control(
			'btn_padding',
			[
				'label' => esc_html__( 'Button Padding', 'mss' ),
		...
		$this->add_control(
			'heading_icon',
			[
				'label' => esc_html__( 'Icon Circle Style', 'mss' ),
		...
		$this->add_responsive_control(
			'play_circle_size',
			[
				'label' => esc_html__( 'Circle Size', 'mss' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
	...
	protected function render() {
		...
		<!-- Simple Popup Modal -->
		<div id="mss-video-modal-<?php echo $this->get_id(); ?>" class="mss-video-modal" style="display:none; position:fixed; z-index:99999; left:0; top:0; width:100%; height:100%; background:rgba(0,0,0,0.95);">
			<div class="mss-video-modal-content" style="position:relative; top:50%; transform:translateY(-50%); width:90%; max-width:1200px; margin:auto;">
				...
				<div class="mss-video-iframe-wrapper" style="position:relative; padding-bottom:56.25%; height:0;">
					<iframe id="mss-iframe-<?php echo $this->get_id(); ?>" width="100%" height="100%" src="" frameborder="0" allowfullscreen style="position:absolute; top:0; left:0; width:100%; height:100%;"></iframe>
				</div>
			</div>
		</div>
