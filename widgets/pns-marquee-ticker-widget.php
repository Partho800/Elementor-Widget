...
class PNS_Marquee_Ticker_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Marquee Text', 'pns-addons-for-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Ticker Items', 'pns-addons-for-elementor' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Solar Panel Installation', 'pns-addons-for-elementor' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'item_link',
			[
				'label'       => esc_html__( 'Item Link', 'pns-addons-for-elementor' ),
		...
		$repeater->add_control(
			'custom_icon',
			[
				'label'       => esc_html__( 'Custom Separator Icon (Optional)', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::ICONS,
				'description' => esc_html__( 'Overrides the global separator icon for this item.', 'pns-addons-for-elementor' ),
			]
		);
		...
		$this->add_control(
			'ticker_items',
			[
				'label'       => esc_html__( 'Ticker Items List', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'default'     => [
					[ 'item_text' => esc_html__( 'Efficiency Consulting', 'pns-addons-for-elementor' ) ],
					[ 'item_text' => esc_html__( 'Energy Storage', 'pns-addons-for-elementor' ) ],
					[ 'item_text' => esc_html__( 'Maintenance and Repair', 'pns-addons-for-elementor' ) ],
					[ 'item_text' => esc_html__( 'Solar Panel Installation', 'pns-addons-for-elementor' ) ],
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Ticker Animation Settings', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'direction',
			[
				'label'   => esc_html__( 'Scroll Direction', 'pns-addons-for-elementor' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'normal'  => esc_html__( 'Right to Left Ã¢Â¬â€¦Ã¯Â¸Â', 'pns-addons-for-elementor' ),
					'reverse' => esc_html__( 'Left to Right Ã¢Å¾Â¡Ã¯Â¸Â', 'pns-addons-for-elementor' ),
				],
				'default' => 'normal',
			]
		);
		...
		$this->add_responsive_control(
			'scroll_speed',
			[
				'label'       => esc_html__( 'Scroll Duration (Seconds)', 'pns-addons-for-elementor' ),
				...
				'description' => esc_html__( 'Smaller value = Faster scroll speed.', 'pns-addons-for-elementor' ),
				'selectors'   => [
		...
		$this->add_control(
			'pause_on_hover',
			[
				'label'        => esc_html__( 'Pause Animation on Hover', 'pns-addons-for-elementor' ),
		...
		$this->add_control(
			'show_icon',
			[
				'label'        => esc_html__( 'Show Separator Icon', 'pns-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'pns-addons-for-elementor' ),
				'label_off'    => esc_html__( 'No', 'pns-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'global_icon',
			[
				'label'     => esc_html__( 'Global Separator Icon', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::ICONS,
				'default'   => [
		...
		$this->add_control(
			'icon_animation',
			[
				'label'     => esc_html__( 'Icon Animation Effect', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'none'  => esc_html__( 'None (Static)', 'pns-addons-for-elementor' ),
					'spin'  => esc_html__( 'Spin / Rotation Ã°Å¸â€â€ž', 'pns-addons-for-elementor' ),
					'pulse' => esc_html__( 'Pulse / Scale Ã°Å¸â€™â€œ', 'pns-addons-for-elementor' ),
				],
				'default'   => 'spin',
				'condition' => [
					'show_icon' => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Ticker Bar Container', 'pns-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'bar_tilt_angle',
			[
				'label'      => esc_html__( 'Tilt / Slant Angle (Degrees)', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'deg' ],
				'range'      => [
					'deg' => [ 'min' => -15, 'max' => 15 ],
		...
		$this->start_controls_section(
			'section_text_style',
			[
				'label' => esc_html__( 'Text & Item Style', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'text_hover_color',
			[
				'label'     => esc_html__( 'Text Hover Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#fff066',
				'selectors' => [
		...
		$this->add_responsive_control(
			'item_spacing',
			[
				'label'      => esc_html__( 'Item Side Padding / Space', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
		...
		$this->start_controls_section(
			'section_icon_style',
			[
				'label'     => esc_html__( 'Separator Icon Style', 'pns-addons-for-elementor' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_icon' => 'yes',
				],
		...
		$this->add_control(
			'icon_hover_color',
			[
				'label'     => esc_html__( 'Icon Hover Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#fff066',
				'selectors' => [
		...
		$this->add_responsive_control(
			'icon_gap',
			[
				'label'      => esc_html__( 'Gap Between Text & Icon', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
					...
					<div class="ce-marquee-track">
						...
						?>
							<?php if ( ! empty( $item_url ) ) : ?>
								<a href="<?php echo esc_url( $item_url ); ?>" class="ce-marquee-item"<?php if ( ! empty( $item['item_link']['is_external'] ) ) : ?> target="_blank"<?php endif; ?><?php if ( ! empty( $item['item_link']['nofollow'] ) ) : ?> rel="nofollow"<?php endif; ?>>
