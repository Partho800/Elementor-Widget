...
class PNS_What_We_Do_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'What We Do Section', 'pns-addons-for-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Feature Cards (Left Grid)', 'pns-addons-for-elementor' ),
		...
		$repeater_cards->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Financial Investment', 'pns-addons-for-elementor' ),
				'label_block' => true,
			]
		);
		...
		$repeater_cards->add_control(
			...
			[
				...
				'default' => esc_html__( 'Quis nostrud exercitation ullamco laboris nisi ut aliquip commodo.', 'pns-addons-for-elementor' ),
				'rows'    => 3,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => [
					[
						'card_title'      => esc_html__( 'Financial Investment', 'pns-addons-for-elementor' ),
						'card_desc'       => esc_html__( 'Quis nostrud exercitation ullamco laboris nisi ut aliquip commodo.', 'pns-addons-for-elementor' ),
						'card_icon'       => [ 'value' => 'fas fa-coins', 'library' => 'fa-solid' ],
						'card_icon_bg'    => '#5eead4',
						'card_icon_color' => '#ffffff',
					],
					[
						'card_title'      => esc_html__( 'Strategic Guidance', 'pns-addons-for-elementor' ),
						'card_desc'       => esc_html__( 'Quis nostrud exercitation ullamco laboris nisi ut aliquip commodo.', 'pns-addons-for-elementor' ),
					...
					[
						'card_title'      => esc_html__( 'Exit Strategy', 'pns-addons-for-elementor' ),
						'card_desc'       => esc_html__( 'Quis nostrud exercitation ullamco laboris nisi ut aliquip commodo.', 'pns-addons-for-elementor' ),
					...
					[
						'card_title'      => esc_html__( 'Advising Startups', 'pns-addons-for-elementor' ),
						'card_desc'       => esc_html__( 'Quis nostrud exercitation ullamco laboris nisi ut aliquip commodo.', 'pns-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'right_column_offset',
			[
				'label'      => esc_html__( 'Right Column Offset (Top/Bottom)', 'pns-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'left_column_offset',
			[
				'label'      => esc_html__( 'Left Column Offset (Top/Bottom)', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'cards_vertical_gap',
			[
				'label'      => esc_html__( 'Card Vertical Space', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXTAREA,
				'default'     => esc_html__( 'Always ready to invest in any business', 'pns-addons-for-elementor' ),
				'rows'        => 2,
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__( 'Description', 'pns-addons-for-elementor' ),
				'type'    => Controls_Manager::TEXTAREA,
				'default' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod diti tempor incididunt ut labore et dolore magna aliqua.', 'pns-addons-for-elementor' ),
				'rows'    => 4,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Checklist Section', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'checklist_title',
			[
				'label'       => esc_html__( 'Checklist Subheading', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'How we help your business', 'pns-addons-for-elementor' ),
				'label_block' => true,
			]
		);
		...
		$repeater_checklist->add_control(
			'item_text',
			[
				'label'       => esc_html__( 'Item Text', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Stage-focused investing', 'pns-addons-for-elementor' ),
				'label_block' => true,
			]
		);
		...
		$repeater_checklist->add_control(
			'item_icon',
			[
				'label'   => esc_html__( 'Item Icon', 'pns-addons-for-elementor' ),
				'type'    => Controls_Manager::ICONS,
				'default' => [
					'value'   => 'fas fa-check',
					'library' => 'fa-solid',
		...
		$this->add_control(
			'checklist_items',
			[
				'label'       => esc_html__( 'Checklist Items', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater_checklist->get_controls(),
				'default'     => [
					[ 'item_text' => esc_html__( 'Stage-focused investing', 'pns-addons-for-elementor' ) ],
					[ 'item_text' => esc_html__( 'Sector specialization', 'pns-addons-for-elementor' ) ],
					[ 'item_text' => esc_html__( 'Active involvement', 'pns-addons-for-elementor' ) ],
					[ 'item_text' => esc_html__( 'Portfolio diversification', 'pns-addons-for-elementor' ) ],
					[ 'item_text' => esc_html__( 'Achieving a return', 'pns-addons-for-elementor' ) ],
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Visual Media / Images', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'primary_media_type',
			[
				'label'   => esc_html__( 'Primary Media Type', 'pns-addons-for-elementor' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
		...
		$this->add_control(
			'primary_image',
			[
				'label'     => esc_html__( 'Primary Image', 'pns-addons-for-elementor' ),
		...
		$this->add_control(
			'show_overlay_image',
			[
				'label'        => esc_html__( 'Show Overlay Circular Image', 'pns-addons-for-elementor' ),
		...
		$this->add_control(
			'overlay_image',
			[
				'label'     => esc_html__( 'Overlay Circular Image', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::MEDIA,
				'default'   => [
					'url' => Utils::get_placeholder_image_src(),
				],
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Read More', 'pns-addons-for-elementor' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Icon Box Settings', 'pns-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'icon_box_size',
			[
				'label'      => esc_html__( 'Box Width/Height', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label'      => esc_html__( 'Icon Font Size', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Box Border Radius', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'default'    => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Card Titles & Text', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Title Hover Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#8b5cf6',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Checklist Style', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Subheading Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#1e293b',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Item Text Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#334155',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Images Composition', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'overlay_img_size',
			[
				'label'      => esc_html__( 'Image Size (Width & Height)', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
		...
		$this->add_responsive_control(
			'overlay_img_right',
			[
				'label'      => esc_html__( 'Offset Right', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [ 'px' => [ 'min' => -100, 'max' => 100 ] ],
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Border Width', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
							...
							<div class="ce-cards-col ce-cards-col-left">
								...
								?>
									<div class="ce-card-item elementor-repeater-item-<?php echo esc_attr( $card['_id'] ); ?>">
										...
										<?php if ( $link_url ) : ?>
											<a href="<?php echo esc_url( $link_url ); ?>"<?php if ( ! empty( $card['card_link']['is_external'] ) ) : ?> target="_blank"<?php endif; ?><?php if ( ! empty( $card['card_link']['nofollow'] ) ) : ?> rel="nofollow"<?php endif; ?> style="text-decoration: none;">
										<?php endif; ?>

										<h3 class="ce-card-title" <?php $this->print_render_attribute_string( $repeater_setting_key ); ?>>
				...
				<div class="ce-col-right">
					<div class="ce-right-content">
						...
						<?php if ( ! empty( $settings['heading'] ) ) : ?>
							<<?php echo tag_escape( $heading_tag ); ?> class="ce-main-heading">
						...
						?>
							<div class="ce-button-wrap">
								<a href="<?php echo esc_url( $btn_url ); ?>" class="ce-button"<?php if ( ! empty( $settings['button_link']['is_external'] ) ) : ?> target="_blank"<?php endif; ?><?php if ( ! empty( $settings['button_link']['nofollow'] ) ) : ?> rel="nofollow"<?php endif; ?>>
