...
class MSS_Premium_Carousel_Widget extends \Elementor\Widget_Base {

    public function get_name() { return 'mss_premium_carousel'; }
    public function get_title() { return __( 'Premium Card Carousel', 'elementor-addon' ); }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control( 'item_short_desc', [
            'label'       => __( 'Short Description', 'mss' ),
            'type'        => \Elementor\Controls_Manager::TEXT,
        ...
        $repeater->add_control( 'item_detailed_desc', [
            'label'       => __( 'Detailed Description (Hover)', 'mss' ),
        ...
        $repeater->add_control( 'social_link_1', [
            'label' => __( 'Social Link 1', 'mss' ),
            'type'  => \Elementor\Controls_Manager::URL,
            'placeholder' => 'https://facebook.com',
        ] );

        $repeater->add_control( 'social_icon_2', [
            'label' => __( 'Social Icon 2', 'mss' ),
            'type'  => \Elementor\Controls_Manager::ICONS,
            'default' => [
        ...
        $repeater->add_control( 'social_link_2', [
            'label' => __( 'Social Link 2', 'mss' ),
            'type'  => \Elementor\Controls_Manager::URL,
            'placeholder' => 'https://twitter.com',
        ] );

        $repeater->add_control( 'social_icon_3', [
            'label' => __( 'Social Icon 3', 'mss' ),
            'type'  => \Elementor\Controls_Manager::ICONS,
            'default' => [
        ...
        $this->start_controls_section( 'section_carousel_settings', [
            'label' => __( 'Carousel Settings', 'mss' ),
            'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
        ] );

        $this->add_responsive_control( 'slides_per_view', [
            'label'   => __( 'Slides Per View', 'mss' ),
        ...
        $this->start_controls_section( 'section_style_card', [
            'label' => __( 'Card Styling', 'mss' ),
            'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
        ] );

        $this->add_control( 'card_bg_color', [
            'label'     => __( 'Card Background Color', 'mss' ),
        ...
        $this->start_controls_section( 'section_style_typography', [
            'label' => __( 'Typography', 'mss' ),
            'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
        ] );

        $this->add_control( 'name_color', [
            'label'     => __( 'Name Color', 'mss' ),
            'type'      => \Elementor\Controls_Manager::COLOR,
            'default'   => '#ffffff',
        ...
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), [
            ...
            'label'    => __( 'Name Typography', 'mss' ),
            'selector' => '{{WRAPPER}} .mss-pc-name',
        ] );

        $this->add_control( 'short_desc_color', [
            'label'     => __( 'Short Description Color', 'mss' ),
            'type'      => \Elementor\Controls_Manager::COLOR,
            'default'   => '#94a3b8',
        ...
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), [
            ...
            'label'    => __( 'Short Desc Typography', 'mss' ),
        ...
        $this->start_controls_section( 'section_style_info', [
            'label' => __( 'Info Box Styling', 'mss' ),
            'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
        ] );

        $this->add_control( 'info_bg_color', [
            'label'     => __( 'Background Fade Color', 'mss' ),
            'type'      => \Elementor\Controls_Manager::COLOR,
        ...
        $this->start_controls_section( 'section_style_overlay', [
            'label' => __( 'Hover Overlay', 'mss' ),
            'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
        ] );

        $this->add_control( 'overlay_bg_color', [
            'label'     => __( 'Overlay Background', 'mss' ),
            'type'      => \Elementor\Controls_Manager::COLOR,
        ...
        $this->add_control( 'detailed_desc_color', [
            'label'     => __( 'Detailed Description Color', 'mss' ),
            'type'      => \Elementor\Controls_Manager::COLOR,
            'default'   => '#e2e8f0',
        ...
        $this->add_group_control( \Elementor\Group_Control_Typography::get_type(), [
            ...
            'label'    => __( 'Detailed Desc Typography', 'mss' ),
        ...
        $this->add_control( 'social_icon_hover_bg', [
            'label'     => __( 'Icon Hover Background', 'mss' ),
            'type'      => \Elementor\Controls_Manager::COLOR,
            'default'   => '#3b82f6',
        ...
        $this->add_responsive_control( 'social_icon_gap', [
            'label'      => __( 'Gap Between Icons', 'mss' ),
            'type'       => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px' ],
        ...
        $this->start_controls_section( 'section_style_navigation', [
            'label' => __( 'Navigation Arrows', 'mss' ),
            'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
            'condition' => [ 'show_arrows' => 'yes' ],
        ] );

        $this->add_control( 'arrow_color', [
            'label'     => __( 'Arrow Color', 'mss' ),
            'type'      => \Elementor\Controls_Manager::COLOR,
            'default'   => '#ffffff',
        ...
        $this->start_controls_section( 'section_style_pagination', [
            'label' => __( 'Pagination Dots', 'mss' ),
            'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
            'condition' => [ 'show_pagination' => 'yes' ],
        ] );

        $this->add_control( 'dot_color', [
            'label'     => __( 'Dot Color', 'mss' ),
            'type'      => \Elementor\Controls_Manager::COLOR,
            'default'   => '#475569',
