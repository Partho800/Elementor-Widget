...
class PNS_Table_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'HTML Table', 'pns-addons-for-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Top Header Section', 'pns-addons-for-elementor' ),
		...
		$this->add_control(
			'show_header',
			[
				'label'        => esc_html__( 'Show Table Header Title', 'pns-addons-for-elementor' ),
		...
		$this->add_control(
			'header_text',
			[
				'label'       => esc_html__( 'Header Title Text', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Flooring Project Overview', 'pns-addons-for-elementor' ),
				'placeholder' => esc_html__( 'Enter table heading', 'pns-addons-for-elementor' ),
				'condition'   => [
					'show_header' => 'yes',
				],
			]
		...
		$this->add_control(
			'header_tag',
			[
				'label'     => esc_html__( 'Header HTML Tag', 'pns-addons-for-elementor' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Table Columns (Headers)', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$column_repeater->add_control(
			'col_title',
			[
				'label'       => esc_html__( 'Column Title', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Column Title', 'pns-addons-for-elementor' ),
				'label_block' => true,
			]
		);
		...
		$column_repeater->add_control(
			'col_width',
			[
				'label'      => esc_html__( 'Column Width', 'pns-addons-for-elementor' ),
		...
		$this->add_control(
			'columns_list',
			[
				'label'       => esc_html__( 'Columns Config', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $column_repeater->get_controls(),
				'default'     => [
					[ 'col_title' => esc_html__( 'S.No.', 'pns-addons-for-elementor' ), 'col_align' => 'center' ],
					[ 'col_title' => esc_html__( 'AREA', 'pns-addons-for-elementor' ), 'col_align' => 'center' ],
					[ 'col_title' => esc_html__( 'FLOORING TYPE', 'pns-addons-for-elementor' ), 'col_align' => 'center' ],
					[ 'col_title' => esc_html__( 'METHOD', 'pns-addons-for-elementor' ), 'col_align' => 'center' ],
					[ 'col_title' => esc_html__( 'ESSENTIAL PRODUCT', 'pns-addons-for-elementor' ), 'col_align' => 'left' ],
					[ 'col_title' => esc_html__( 'LOCATION', 'pns-addons-for-elementor' ), 'col_align' => 'center' ],
				],
		...
		$this->start_controls_section(
			'section_table_rows',
			[
				'label' => esc_html__( 'Table Rows Content', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'first_col_is_header',
			[
				'label'        => esc_html__( 'First Column acts as Row Header', 'pns-addons-for-elementor' ),
				'description'  => esc_html__( 'Check this if the leftmost cell in each row is a label/header.', 'pns-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$cell_repeater->add_control(
			'cell_content',
			[
				'label'       => esc_html__( 'Cell Content', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'label_block' => true,
			]
		...
		$this->add_control(
			'cells_list',
			[
				'label'       => esc_html__( 'All Table Cells (Click + for next cell)', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::REPEATER,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Responsiveness & Scroll', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'horizontal_scroll',
			[
				'label'        => esc_html__( 'Enable Horizontal Scroll', 'pns-addons-for-elementor' ),
				'description'  => esc_html__( 'Scroll will appear only inside the table if column widths exceed the layout width.', 'pns-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'pns-addons-for-elementor' ),
				'label_off'    => esc_html__( 'No', 'pns-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'show_scroll_hint',
			[
				'label'        => esc_html__( 'Show Swipe Hint on Mobile/Tablet', 'pns-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'pns-addons-for-elementor' ),
				'label_off'    => esc_html__( 'No', 'pns-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'scroll_hint_text',
			[
				'label'       => esc_html__( 'Swipe Hint Text', 'pns-addons-for-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'â† Swipe horizontally to view full table â†’', 'pns-addons-for-elementor' ),
				'condition'   => [
					'horizontal_scroll' => 'yes',
		...
		$this->add_responsive_control(
			'table_max_width',
			[
				'label'      => esc_html__( 'Table Container Max Width', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'vw' ],
				'range'      => [
					'px' => [ 'min' => 200, 'max' => 1600 ],
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Top Header Style', 'pns-addons-for-elementor' ),
		...
		$this->add_responsive_control(
			'header_margin',
			[
				'label'      => esc_html__( 'Margin', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'default'    => [
		...
		$this->start_controls_section(
			'section_th_style',
			[
				'label' => esc_html__( 'Column Headers Style', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'th_padding',
			[
				'label'      => esc_html__( 'Header Cell Padding', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'default'    => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Row Header (First Column) Style', 'pns-addons-for-elementor' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
		...
		$this->start_controls_section(
			'section_td_style',
			[
				'label' => esc_html__( 'Body Cells Style', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'td_bg_color',
			[
				'label'     => esc_html__( 'Cell Background Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#ffffff',
				'selectors' => [
		...
		$this->add_control(
			'td_text_color',
			[
				'label'     => esc_html__( 'Cell Text Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#334155',
				'selectors' => [
		...
		$this->add_responsive_control(
			'td_padding',
			[
				'label'      => esc_html__( 'Cell Padding', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'default'    => [
					'top' => '16', 'right' => '16', 'bottom' => '16', 'left' => '16', 'unit' => 'px',
		...
		$this->add_responsive_control(
			'row_height',
			[
				'label'      => esc_html__( 'Min Row Height', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [ 'min' => 30, 'max' => 200 ],
		...
		$this->add_control(
			'enable_zebra',
			[
				'label'        => esc_html__( 'Zebra Stripes (Odd/Even Rows)', 'pns-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'pns-addons-for-elementor' ),
				'label_off'    => esc_html__( 'No', 'pns-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'zebra_odd_bg',
			[
				'label'     => esc_html__( 'Odd Rows Background', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#f8fafc',
				'selectors' => [
		...
		$this->add_control(
			'zebra_odd_color',
			[
				'label'     => esc_html__( 'Odd Rows Text Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'zebra_even_bg',
			[
				'label'     => esc_html__( 'Even Rows Background', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#ffffff',
				'selectors' => [
		...
		$this->add_control(
			'zebra_even_color',
			[
				'label'     => esc_html__( 'Even Rows Text Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'enable_hover',
			[
				'label'        => esc_html__( 'Row Hover Highlight', 'pns-addons-for-elementor' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'pns-addons-for-elementor' ),
				'label_off'    => esc_html__( 'No', 'pns-addons-for-elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'hover_row_bg',
			[
				'label'     => esc_html__( 'Hover Row Background', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#f1f5f9',
				'selectors' => [
		...
		$this->add_control(
			'hover_row_color',
			[
				'label'     => esc_html__( 'Hover Row Text Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Borders, Shadow & Box Style', 'pns-addons-for-elementor' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'cell_border_color',
			[
				'label'     => esc_html__( 'Grid/Cell Border Color', 'pns-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#e2e8f0',
				'selectors' => [
		...
		$this->add_control(
			'cell_border_width',
			[
				'label'      => esc_html__( 'Grid/Cell Border Width', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'default'    => [
		...
		$this->add_responsive_control(
			'table_border_radius',
			[
				'label'      => esc_html__( 'Table Border Radius', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Table Wrapper Margin', 'pns-addons-for-elementor' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
		...
		$this->start_controls_section(
			'section_hint_style',
			[
				'label'     => esc_html__( 'Swipe Hint Style', 'pns-addons-for-elementor' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'horizontal_scroll' => 'yes',
					'show_scroll_hint'  => 'yes',
					...
					<thead>
						<tr>
							<?php foreach ( $columns as $index => $column ) : 
								...
								?>
								<th class="ce-table-th elementor-repeater-item-<?php echo esc_attr( $column['_id'] ); ?>" style="<?php echo esc_attr( $col_style ); ?>" data-col-index="<?php echo esc_attr( $index ); ?>">
						...
						<?php foreach ( $rows_data as $row_index => $row_item ) : ?>
							<tr class="ce-table-tr">
								...
								foreach ( $columns as $col_index => $column ) :
									...
									if ( $is_row_header ) : ?>
										<th scope="row" class="ce-table-th-row elementor-repeater-item-<?php echo esc_attr( $column['_id'] ); ?>" style="<?php echo esc_attr( $cell_style ); ?>" data-col-index="<?php echo esc_attr( $col_index ); ?>">
											<?php echo wp_kses_post( $cell_val ); ?>
										</th>
									<?php else : ?>
										<td class="ce-table-td elementor-repeater-item-<?php echo esc_attr( $column['_id'] ); ?>" style="<?php echo esc_attr( $cell_style ); ?>" data-col-index="<?php echo esc_attr( $col_index ); ?>">
											<?php echo wp_kses_post( $cell_val ); ?>
										</td>
									<?php endif;
								endforeach;
